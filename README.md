...
The educational content (the guides in `src/content/` and their translations) is licensed under [Creative Commons CC BY 4.0](https://creativecommons.org/licenses/by/4.0/).
