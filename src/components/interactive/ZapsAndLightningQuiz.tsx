...
export function ZapsAndLightningQuiz({ className }: ZapsAndLightningQuizProps) {
  ...
  useQuizCompletion("zaps-and-lightning", showResults, questions, answers);
    ...
    return (
      <div className={cn(
        ...
        <div className="flex flex-col items-center text-center">
          <Zap aria-hidden="true" strokeWidth={1.5} className="h-6 w-6 animate-pulse text-gray-400 motion-reduce:animate-none dark:text-gray-500" />
    ...
    return (
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          >
            <Zap aria-hidden="true" strokeWidth={1.5} className="h-6 w-6 text-primary-text dark:text-primary-400" />
          </div>
...
function renderOptionIcon(optionId: string) {
  ...
  switch (optionId) {
    ...
    case "optional":
      return <Wallet aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "address":
      return <CreditCard aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "hundred":
      return <Bitcoin aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "seed":
