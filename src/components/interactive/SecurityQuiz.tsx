    ...
    return (
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          >
            <ShieldCheck aria-hidden="true" strokeWidth={1.5} className="h-6 w-6 text-primary-text dark:text-primary-400" />
          </div>
...
function renderOptionIcon(optionId: string) {
  ...
  switch (optionId) {
    ...
    case "321":
      return <ShieldCheck aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "photo":
      return <AlertTriangle aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "personas":
      return <EyeOff aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "link":
