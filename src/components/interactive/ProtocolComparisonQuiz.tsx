...
export function ProtocolComparisonQuiz({ className }: ProtocolComparisonQuizProps) {
  ...
  const rawQuestions = getValue("guides.protocolComparison.quiz.questions");
  const questions: Question[] = Array.isArray(rawQuestions) ? rawQuestions : [];
  const quizTitle = t("guides.protocolComparison.quiz.title") || "Protocol Comparison Quiz";
  ...
  useQuizCompletion("protocol-comparison", showResults, questions, answers);
    ...
    return (
      <div className={cn(
        ...
        <div className="flex flex-col items-center text-center">
          <GitCompare aria-hidden="true" strokeWidth={1.5} className="h-6 w-6 animate-pulse text-gray-400 motion-reduce:animate-none dark:text-gray-500" />
    ...
    return (
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          >
            <GitCompare aria-hidden="true" strokeWidth={1.5} className="h-6 w-6 text-primary-text dark:text-primary-400" />
          </div>
          ...
          >
            <a
              ...
              href={guidePath("what-is-nostr", locale)}
            >
              {t("ui.quiz.nostrBasics")}
            </a>
            <a
...
function renderOptionIcon(optionId: string) {
  ...
  switch (optionId) {
    ...
    case "nostr-bluesky":
      return <Network aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "permissionless":
    ...
    default:
      return <GitCompare aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
  }
}
