...
export function RelaysDemystifiedQuiz({ className }: RelaysDemystifiedQuizProps) {
  ...
  useQuizCompletion("relays-demystified", showResults, questions, answers);
    ...
    return (
      <div className={cn(
        ...
        <div className="flex flex-col items-center text-center">
          <Server aria-hidden="true" strokeWidth={1.5} className="h-6 w-6 animate-pulse text-gray-400 motion-reduce:animate-none dark:text-gray-500" />
    ...
    return (
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          >
            <Server aria-hidden="true" strokeWidth={1.5} className="h-6 w-6 text-primary-text dark:text-primary-400" />
          </div>
...
function renderOptionIcon(optionId: string) {
  ...
  switch (optionId) {
    case "offices":
      return <Mail aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "no-see":
      return <Unlink aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "better":
      return <DollarSign aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "balance":
