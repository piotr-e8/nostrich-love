...
export function MultiClientQuiz({ className }: MultiClientQuizProps) {
  ...
  useQuizCompletion("multi-client", showResults, questions, answers);
    ...
    return (
      <div className={cn(
        ...
        <div className="flex flex-col items-center text-center">
          <MonitorSmartphone aria-hidden="true" strokeWidth={1.5} className="h-6 w-6 animate-pulse text-gray-400 motion-reduce:animate-none dark:text-gray-500" />
    ...
    return (
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          >
            <MonitorSmartphone aria-hidden="true" strokeWidth={1.5} className="h-6 w-6 text-primary-text dark:text-primary-400" />
          </div>
...
function renderOptionIcon(optionId: string) {
  ...
  switch (optionId) {
    case "optimization":
      return <CheckCircle aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "content":
      return <MonitorSmartphone aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "optimized":
      return <Monitor aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "nsec":
    ...
    default:
      return <Smartphone aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
  }
}
