...
export function NIP05IdentityQuiz({ className }: NIP05IdentityQuizProps) {
  ...
  useQuizCompletion("nip05-identity", showResults, questions, answers);
    ...
    return (
      <div className={cn(
        ...
        <div className="flex flex-col items-center text-center">
          <AtSign aria-hidden="true" strokeWidth={1.5} className="h-6 w-6 animate-pulse text-gray-400 motion-reduce:animate-none dark:text-gray-500" />
    ...
    return (
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          >
            <AtSign aria-hidden="true" strokeWidth={1.5} className="h-6 w-6 text-primary-text dark:text-primary-400" />
          </div>
...
function renderOptionIcon(optionId: string) {
  ...
  switch (optionId) {
    case "human":
      return <AtSign aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "appearance":
    ...
    case "specific":
      return <FileJson aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "no-flexible":
