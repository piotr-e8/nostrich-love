    ...
    return (
      <div className={cn(
        ...
        <div className="flex flex-col items-center text-center">
          <MessageSquareLock className="h-12 w-12 text-primary-600 dark:text-primary-400 animate-pulse" />
    ...
    return (
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          >
            <MessageSquareLock className="h-12 w-12 text-primary-600 dark:text-primary-400" />
          </div>
...
function renderOptionIcon(optionId: string) {
  switch (optionId) {
    case "seal":
      return <MessageSquareLock className="h-5 w-5 text-primary-600 dark:text-primary-400" />;
    case "metadata":
