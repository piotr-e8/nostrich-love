...
export function NIP17PrivateMessagesQuiz({ className }: NIP17PrivateMessagesQuizProps) {
  ...
  const rawQuestions = getValue("guides.nip17PrivateMessages.quiz.questions");
  const questions: Question[] = Array.isArray(rawQuestions) ? rawQuestions : [];
  const quizTitle = t("guides.nip17PrivateMessages.quiz.title") || "NIP-17 Private Messages Quiz";
  ...
  useQuizCompletion("nip17-private-messages", showResults, questions, answers);
    ...
    return (
      <div className={cn(
        ...
        <div className="flex flex-col items-center text-center">
          <MessageSquareLock aria-hidden="true" strokeWidth={1.5} className="h-6 w-6 animate-pulse text-gray-400 motion-reduce:animate-none dark:text-gray-500" />
    ...
    return (
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          >
            <MessageSquareLock aria-hidden="true" strokeWidth={1.5} className="h-6 w-6 text-primary-text dark:text-primary-400" />
          </div>
...
function renderOptionIcon(optionId: string) {
  ...
  switch (optionId) {
    case "seal":
      return <MessageSquareLock aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "metadata":
      return <Eye aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "content-only":
      return <Unlock aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "gibberish":
    ...
    default:
      return <Lock aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
  }
}
