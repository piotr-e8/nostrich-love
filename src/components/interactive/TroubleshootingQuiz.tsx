...
export function TroubleshootingQuiz({ className }: TroubleshootingQuizProps) {
  ...
  useQuizCompletion("troubleshooting", showResults, questions, answers);
    ...
    return (
      <div className={cn(
        ...
        <div className="flex flex-col items-center text-center">
          <Wrench aria-hidden="true" strokeWidth={1.5} className="h-6 w-6 animate-pulse text-gray-400 motion-reduce:animate-none dark:text-gray-500" />
    ...
    return (
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          >
            <Wrench aria-hidden="true" strokeWidth={1.5} className="h-6 w-6 text-primary-text dark:text-primary-400" />
          </div>
          ...
          >
            <a
              ...
              href={guidePath("relay-guide", locale)}
            >
      ...
      >
          ...
          <div className="mt-6 space-y-3">
            {currentQuestion.options.map((option, i) => {
              ...
              let buttonClasses = "w-full rounded-lg border px-4 py-3 text-start transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary ";

              if (showState) {
                // After an answer is selected
                if (isAnswer) {
                  buttonClasses += "border-success-500 bg-success-500/10 ";
                } else if (isSelected) {
                  buttonClasses += "border-error-500 bg-error-500/15 animate-shake motion-reduce:animate-none ";
                } else {
                  buttonClasses += "border-gray-200 bg-gray-50 dark:border-gray-800 dark:bg-gray-900 ";
                }
              } else {
                ...
                if (isSelected) {
                  ...
                  buttonClasses += "border-gray-200 bg-white hover:border-gray-300 hover:bg-gray-50 dark:border-gray-800 dark:bg-gray-900 dark:hover:border-gray-700 dark:hover:bg-gray-800 ";
                }
              }
...
function renderOptionIcon(optionId: string) {
  ...
  switch (optionId) {
    case "relays":
      return <Eye aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "relay-limits":
      return <MessageSquare aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "no-recovery":
      return <Key aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "wss":
      return <Wifi aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "nip05":
      return <UserX aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "wallet":
      return <Zap aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    default:
      return <Wrench aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
  }
}
