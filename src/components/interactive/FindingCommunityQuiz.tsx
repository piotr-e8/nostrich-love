...
export function FindingCommunityQuiz({ className }: FindingCommunityQuizProps) {
  ...
  useQuizCompletion("finding-community", showResults, questions, answers);
    ...
    return (
      <div className={cn(
        ...
        <div className="flex flex-col items-center text-center">
          <Users aria-hidden="true" strokeWidth={1.5} className="h-6 w-6 animate-pulse text-gray-400 motion-reduce:animate-none dark:text-gray-500" />
    ...
    return (
      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          >
            <Users aria-hidden="true" strokeWidth={1.5} className="h-6 w-6 text-primary-text dark:text-primary-400" />
          </div>
...
function renderOptionIcon(optionId: string) {
  ...
  switch (optionId) {
    case "few":
      return <Hash aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "taste":
      return <UserPlus aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "fifty":
      return <Users aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "value":
      return <Heart aria-hidden="true" strokeWidth={1.5} className={iconClass} />;
    case "nsec":
