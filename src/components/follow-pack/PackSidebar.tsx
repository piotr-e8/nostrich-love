        ...
        {hasSelections && (
          <div className="p-4 border-t border-gray-100 dark:border-gray-700 space-y-2">
            <button
              type="button"
              onClick={onExport}
              className="w-full py-2.5 px-4 bg-primary-600 text-white rounded-lg font-medium hover:bg-primary-700 transition-colors flex items-center justify-center gap-2 relative z-10"
            >
