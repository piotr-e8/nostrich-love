...
- **Relays** store it and serve it to anyone who asks—but by default they don't pass it on to other relays
- **Followers** receive it from relays they're connected to, so your relay lists need to overlap
