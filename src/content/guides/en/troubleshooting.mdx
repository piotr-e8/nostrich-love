...
- **Note**: Nobody can delete their account, and blocking them is only a filter
  on your side. They stay visible to everyone else, so telling your own audience
  which npub is really yours does more than blocking does
