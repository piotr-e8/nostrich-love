...
<div className="cta-section my-12 text-center py-8 bg-primary/5 rounded-lg">
  <h3 className="text-2xl font-bold mb-4">Ready to choose your protocol?</h3>
  <p className="text-muted-foreground mb-6">
    If Nostr sounds right for you, start with our comprehensive beginner's guide
    to create your keys and join the network.
  </p>
  <CTAButton variant="primary" size="lg" href="/guides/quickstart">
    Jump to Quickstart Guide →
  </CTAButton>
  <p className="text-sm text-muted-foreground mt-2">
    (Skips ahead 3 guides—use the bottom navigation to go step-by-step)
  </p>
</div>
...
_Last updated: February 2025 | Protocol versions: Nostr (NIPs current), ActivityPub (W3C Recommendation), AT Protocol (v1.0)_
