...
One of the most popular free providers.
...
3. Provide your npub
4. Verify via nostr DM or email
5. Done! Your identifier: `alice@nostrplebs.com`
...
- Popular names taken quickly
- You're `username@nostrplebs.com` (not your own domain)
...
4. Pay with Bitcoin or Lightning
...
Jump ahead to learn about troubleshooting or explore related topics:

<CTA
  href="/guides/troubleshooting"
  title="Problem Solving Guide"
  description="Fix common Nostr issues and get back on track"
  buttonText="Problem Solving Guide →"
  variant="outline"
/>
...
- [NostrPlebs](https://nostrplebs.com) - Free NIP-05
