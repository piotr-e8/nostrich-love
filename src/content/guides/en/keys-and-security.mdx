...
<AlertBanner
  type="warning"
  title="This is the most important page. Read carefully."
>
  Your keys are your identity. Lose them = lose your account forever. No
  exceptions. No recovery. Take this seriously.
</AlertBanner>
...
**GOOD:** 4. ✅ Encrypted cloud storage (iCloud/Google Drive with encryption) 5. ✅ Metal seed plate (fireproof/waterproof)
...
**Permanent loss. No exceptions.**

Nostr has no:

- "Forgot password" button
- Customer support to call
- Admin who can reset your account
- Way to recover lost keys

**Real examples:**

- User lost $50,000 in Bitcoin tips because they didn't back up their nsec
- Influencer lost 10,000 followers when their phone died
- Developer lost years of posts and reputation

**Don't be that person.** Back up your keys now.
...
- [ ] nsec1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq
- [x] npub1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq

**Answer:** Only the npub (starts with "npub"). Never share anything starting with "nsec".
