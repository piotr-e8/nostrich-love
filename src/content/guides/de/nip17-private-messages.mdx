...
<DiagramLayers
  layers={[
    { label: "Gift Wrap (äußere Schicht)", note: "Zufälliger pubkey, Empfänger-Hinweis — mehr sieht ein Relay nicht" },
    { label: "Seal (innere Schicht)", note: "Verschlüsselt mit einem ephemeren Schlüssel" },
