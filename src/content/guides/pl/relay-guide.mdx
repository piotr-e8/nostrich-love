...
<Callout variant="info">
  **Opierając się na wcześniejszej wiedzy:** Ta sekcja krótko przegląda analogię pocztową
  z [Relaye Rozszyfrowane](/pl/guides/relays-demystified). Jeśli pamiętasz,
...
- Każda poczta trzyma własną kopię—nie przekazują listów sobie nawzajem
...
- **Obserwujący** odbierają ją z relayów, z którymi są połączeni, więc Wasze listy relayów muszą się pokrywać
