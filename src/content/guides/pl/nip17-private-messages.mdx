...
<DiagramLayers
  layers={[
    { label: "Gift wrap (warstwa zewnętrzna)", note: "Losowy pubkey, wskazówka odbiorcy — tylko tyle widzi relay" },
    { label: "Seal (warstwa wewnętrzna)", note: "Zaszyfrowany kluczem efemerycznym" },
...
Seal i gift wrap opisują, jak wiadomość jest zapakowana. Trzeci element —
**event kind 10050** — opisuje, dokąd jest dostarczana. To mała, publiczna
lista relayów, które przyjmują Twoje prywatne wiadomości.
...
wiadomości" i klienci nie powinny nawet próbować — więc DM-y adresowane do
Ciebie po cichu nigdy nie są dostarczane. Po żadnej stronie nie ma błędu.
...
Niektórzy klienci publikują tę listę automatycznie po włączeniu NIP-17. Nie
zakładaj tego: zweryfikuj dostarczanie w Kroku 5, zanim na tym polegasz.
...
### Krok 5: Zweryfikuj Sukces Migracji
...
3. ✅ Opublikuj swoją listę relayów DM (kind 10050) — bez niej nic nie dociera
4. ✅ Zweryfikuj ze swoimi kontaktami, że wspierają NIP-17
5. ✅ Zacznij używać NIP-17 dla wszystkich nowych prywatnych rozmów
...
_Ostatnia aktualizacja: 28 lipca 2026_
...
- [Prywatność i Bezpieczeństwo: Dogłębna Analiza](/pl/guides/privacy-security)
